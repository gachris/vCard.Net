...
public class VCardSerializerTests : IClassFixture<VCardFixture>
{
    ...
    {
        var dataFilePath = Path.Combine(AppContext.BaseDirectory, "v3.0/Data/John Doe.vcf");
    ...
    {
        // Prepare the path to the vCard file
        var dataFilePath = Path.Combine(AppContext.BaseDirectory, "v3.0/Data/Contacts.vcf");
