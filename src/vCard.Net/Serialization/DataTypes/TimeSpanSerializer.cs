...
/// <summary>
/// Serializer for TimeSpan data type, providing serialization and deserialization methods.
/// </summary>
public class TimeSpanSerializer : SerializerBase
{
    private static readonly Regex TimespanMatch =
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TimeSpanSerializer"/> class with the specified serialization context.
    /// </summary>
