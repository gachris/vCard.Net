...
namespace vCard.Net
{
    ...
    public class CardParameter : CardObject, IValueObject<string>
    {
        private HashSet<string> _values;

        public CardParameter() => Initialize();

        public CardParameter(string name) : base(name) => Initialize();

        public CardParameter(string name, string value) : base(name)
        {
            Initialize();
            AddValue(value);
        }

        public CardParameter(string name, IEnumerable<string> values) : base(name)
        {
            Initialize();
