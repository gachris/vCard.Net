namespace vCard.Net
{
    public interface ICopyable
    {
        ...
        /// (i.e. CardDateTime). For most other types, it's unnecessary overhead. The pattern that identifies whether it's necessary to copy
        /// or not is whether arithmetic operations mutate fields or properties. CardDateTime is a good example where + and - would otherwise
