...
internal static class DateUtil
{
    ...
    /// target time zone string. Some older vCard programs would generate nonstandard time zone strings, and this secondary check works around
    /// that.
    /// </summary>
    ...
    public static DateTimeZone GetZone(string tzId, bool useLocalIfNotFound = true)
    {
        ...
        return useLocalIfNotFound ? LocalDateTimeZone : throw new ArgumentException($"Unrecognized time zone id {tzId}");
    }
